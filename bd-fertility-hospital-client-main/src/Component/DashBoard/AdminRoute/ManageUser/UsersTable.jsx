                  ...
                  {users?.map((person) => (
                    <tr key={person.email}>
                      ...
                      <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-500">
                        <button
                          onClick={() => handleMakeUserToAdmin(person)}
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <button
                          ...
                          className="relative inline-flex items-center justify-center px-4 py-2 overflow-hidden font-mono font-medium tracking-tighter text-white bg-[#DF5EA2] rounded-lg group"
                        >
